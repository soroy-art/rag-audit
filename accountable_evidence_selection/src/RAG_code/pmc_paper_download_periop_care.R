...
guideline_metadata = read.csv(file="../data/csv-pubmedpmco-set-perioperative-care.csv", header = TRUE, stringsAsFactors = FALSE)

pmcids = guideline_metadata$PMCID
out_dir = "../results/pmc_openaccess_xml_periop_care"
